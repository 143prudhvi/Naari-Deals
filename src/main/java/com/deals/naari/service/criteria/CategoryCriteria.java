...
/**
 * Criteria class for the {@link com.deals.naari.domain.Category} entity. This class is used
 * in {@link com.deals.naari.web.rest.CategoryResource} to receive all the possible filtering options from
...
public class CategoryCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, parent, title, subTitle, imageUrl, description, country, code, status, distinct);
    }
