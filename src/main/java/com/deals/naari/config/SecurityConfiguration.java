...
import com.deals.naari.security.*;
import com.deals.naari.security.jwt.*;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/naari-check-user-name").permitAll()
            .antMatchers("/api/naari-register").permitAll()
            ...
            .antMatchers("/send-private-message/**").permitAll()
            .antMatchers("/send-broad-message").permitAll()
            .antMatchers("/send-broad-message/**").permitAll()
         ...
         // .antMatchers("/websocket/tracker").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/naariwebsocket/**").permitAll()
